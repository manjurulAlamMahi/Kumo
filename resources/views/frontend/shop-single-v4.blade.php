		...
		<div class="row justify-content-between">
			...
			<div class="col-xl-5 col-lg-6 col-md-12 col-sm-12">
				<div class="quick_view_slide">
					<div class="single_view_slide"><a href="assets/img/product/4.jpg" data-lightbox="roadtrip" class="d-block mb-4"><img src="assets/img/product/4.jpg" class="img-fluid rounded" alt="" /></a></div>
				...
				<div class="prd_details pl-3">
					...
					<div class="prt_02 mb-3">
						...
						<div class="text-left">
							...
							<div class="elis_rty"><span class="ft-medium text-muted line-through fs-md mr-2">$199</span><span class="ft-bold theme-cl fs-lg mr-2">$110</span></div>
						</div>
					</div>
